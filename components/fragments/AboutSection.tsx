...
export default function AboutSection() {
  ...
  return (
    <section id='about' ref={aboutRef} className='max-w-7xl mx-auto py-8 md:py-24 space-y-8'>
      <h2 className='text-4xl md:text-5xl font-medium'>About Me</h2>
      <div className='space-y-8 md:space-y-0 flex flex-col-reverse md:grid md:grid-cols-[3fr_2fr] md:gap-12 lg:gap-16 items-center'>
        ...
        <div className='aspect-square w-full max-w-sm mx-auto md:mx-0 relative overflow-hidden rounded-full'>
      ...
      <div className='grid md:grid-cols-2 gap-16'>
        <div className='space-y-8'>
          <h2 className='text-3xl md:text-4xl font-medium'>Experience</h2>

          <div className='border-l-2 border-muted pl-6 py-2 space-y-4'>
        ...
        <div className='space-y-8'>
          <h2 className='text-3xl md:text-4xl font-medium'>Education</h2>
